package com.simats.orthoflexhip.apiresponse;

public class Constant {
    public static final String VIEW_PATIENT_ID_FOR_MEDICAL_DETAILS="PatientIdForMedicalDetails";
    public static final String SF_NAME="MyPrefs";
    ...
    public static final String SPINNER6="spinner6";
